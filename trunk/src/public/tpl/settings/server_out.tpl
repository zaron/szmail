<fieldset id="settings_server_out">
	<legend>Ausgangs-Server</legend>
	...
	<div class="row">
		<div>
			...
			<input name="host" type="text" value="smtp.googlemail.com"/>
		</div>
		<div>
			<label for="port">Port</label>
			<input name="port" type="text" value="25"/>
		</div>
	</div>
	...
	<div>
		...
		<select name="authentication">
			<option value="password">Nicht Ben&ouml;tigt</option>
